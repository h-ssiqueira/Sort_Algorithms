...
void BitonicSort(int array[], int low, int length, int direction){ // Direction refers to ascending or descending order
	if(length > 1){
	    int middle = length / 2;
...
int main(){
    srand(time(NULL));
    int option_sort, option_category, array[leng], arrayPOF2[powerof2],i;
